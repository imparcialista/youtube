...
def main():
    ...
    mensagem('Digite SAIR para encerrar o backup')
    ...
    while not sair:
        ...
        if escolha == 'sair':
            mensagem('Encerrando o backup...')
            break

        elif escolha == '?' or escolha == 'ajuda':
            print_colorido('\nDigite SAIR para encerrar o backup')
            ...
            if planilha_atualizar == '':
                ...
                if df_atualizar.columns[0] == 'SKU':
                    ...
                    if df_atualizar.columns[1] == 'EST':
                        ...
                        mensagem_colorida(
                            'ATENÇÃO: Produtos que estão oferecendo '
                        ...
                        mensagem_colorida(
                            'ATENÇÃO: Produtos com promoção ativa não serão alterados para '
